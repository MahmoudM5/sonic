...
local hash = database:sismember(bot_id.."Tshake:Basic:Creator23"..msg.chat_id_, msg.sender_user_id_) 
...
local hash = database:sismember(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, msg.sender_user_id_) 
...
local hash = database:sismember(bot_id.."Tshake:Creator"..msg.chat_id_, msg.sender_user_id_) 
...
var = true 
elseif database:sismember(bot_id.."Tshake:Basic:Creator23"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."Tshake:Basic:Creator"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."Tshake:Creator"..chat_id, user_id) then
var = true 
...
var = "المالك"
elseif database:sismember(bot_id.."Tshake:Basic:Creator"..chat_id, user_id) then
var = database:get(bot_id.."Tshake:SupCreator:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."Tshake:Creator"..chat_id, user_id) then
var = database:get(bot_id.."Tshake:Creator:Rd"..chat_id) or "المنشئ" 
elseif database:sismember(bot_id.."manger:all", user_id) then
var = "المدير العام"
elseif database:sismember(bot_id.."Tshake:Manager"..chat_id, user_id) then
...
database:sadd(bot_id.."Tshake:Creator"..idg,idmsh)
end;end
if v.MDER then
...
database:sadd(bot_id.."Tshake:Basic:Creator"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
...
database:sadd(bot_id..'Tshake:UsersBot',idu) 
end
...
if not Special(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."Tshake:flooding:settings:"..msg.chat_id_,"flood") then 
...
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Tshake:Lock:text"..msg.chat_id_) and not Special(msg) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false 
end 
--------------------------------------------------------------------------------------------------------------
...
if database:get(bot_id.."Tshake:Lock:User:Name"..msg.chat_id_) == "del" and not Special(msg) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:User:Name"..msg.chat_id_) == "ked" and not Special(msg) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:User:Name"..msg.chat_id_) == "kick" and not Special(msg) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:User:Name"..msg.chat_id_) == "ktm" and not Special(msg) then 
database:sadd(bot_id.."Tshake:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."Tshake:Lock:hashtak"..msg.chat_id_) == "del" and not Special(msg) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:hashtak"..msg.chat_id_) == "ked" and not Special(msg) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:hashtak"..msg.chat_id_) == "kick" and not Special(msg) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:hashtak"..msg.chat_id_) == "ktm" and not Special(msg) then 
database:sadd(bot_id.."Tshake:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then 
if database:get(bot_id.."Tshake:Lock:Cmd"..msg.chat_id_) == "del" and not Special(msg) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:Cmd"..msg.chat_id_) == "ked" and not Special(msg) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:Cmd"..msg.chat_id_) == "kick" and not Special(msg) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:Cmd"..msg.chat_id_) == "ktm" and not Special(msg) then 
database:sadd(bot_id.."Tshake:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."Tshake:Lock:Link"..msg.chat_id_) == "del" and not Special(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:Link"..msg.chat_id_) == "ked" and not Special(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:Link"..msg.chat_id_) == "kick" and not Special(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."Tshake:Lock:Link"..msg.chat_id_) == "ktm" and not Special(msg) then
database:sadd(bot_id.."Tshake:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
database:del(bot_id.."Tshake:Basic:Creator"..msg.chat_id_)
texts = "٭ تم مسح المنشئين الاساسيين"
send(msg.chat_id_, msg.id_, texts)
end
if text == "مسح المالكين" and DevBot(msg) then
database:del(bot_id.."Tshake:Basic:Creator23"..msg.chat_id_)
texts = "٭ تم مسح المالكين"
send(msg.chat_id_, msg.id_, texts)
end
if text == "مسح المنشئين" and SupCreator(msg) then
database:del(bot_id.."Tshake:Creator"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Tshake:Basic:Creator"..msg.chat_id_)
...
local list = database:smembers(bot_id.."Tshake:Basic:Creator23"..msg.chat_id_)
t = "\n٭ قائمة المالكين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tshake:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."Tshake:Creator"..msg.chat_id_)
t = "\n٭ قائمة المنشئين \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."Tshake:User:Name" .. v)
if username then
...
function Function_Tshake(extra, result, success)
database:srem(bot_id.."Tshake:Basic:Creator23"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tshake(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tshake:Basic:Creator23"..msg.chat_id_, result.id_)
...
if text == ("مسح الردود المتعدده") and DevSonic(msg) then
...
if text == ("الردود المتعدده") and DevSonic(msg) then
...
if text == "اضف رد متعدد" and DevSonic(msg) then
...
if text == "حذف رد متعدد" and DevSonic(msg) then
...
function Function_Tshake(extra, result, success)
database:sadd(bot_id.."Tshake:Basic:Creator23"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tshake:Basic:Creator23"..msg.chat_id_, result.id_)
...
function Function_Tshake(extra, result, success)
database:sadd(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, userid)
...
if da.status_.ID == "ChatMemberStatusCreator" then
function Function_Tshake(extra, result, success)
database:srem(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, result.sender_user_id_)
...
function Function_Tshake(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, userid)
...
function Function_Tshake(extra, result, success)
database:sadd(bot_id.."Tshake:Creator"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Tshake:Creator"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."Tshake:Creator"..msg.chat_id_, userid)
...
function Function_Tshake(extra, result, success)
database:srem(bot_id.."Tshake:Creator"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","٭ تم تنزيله من المنشئين") 
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
end
...
function Function_Tshake(extra, result, success)
if result.id_ then
database:srem(bot_id.."Tshake:Creator"..msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","٭ تم تنزيله من المنشئين") 
else
send(msg.chat_id_, msg.id_,"٭ لا يوجد حساب بهاذا المعرف")
end
...
database:srem(bot_id.."Tshake:Creator"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","٭ تم تنزيله من المنشئين") 
end
...
if database:sismember(bot_id.."Tshake:Lock:pin",msg.chat_id_) and not Creator(msg) then
...
database:sadd(bot_id.."Tshake:allM"..msg.chat_id_, msg.id_)
end

if text == ("عدد الميديا") and Admin(msg) then  
local gmria = database:scard(bot_id.."Tshake:allM"..msg.chat_id_)  
...
database:set(bot_id.."Tshake:SupCreator:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"٭ تم تغير رد المنشئ الاساسي الى » "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Manger(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
database:set(bot_id.."Tshake:Creator:Rd"..msg.chat_id_,Teext)
...
if database:sismember(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."Tshake:Creator"..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
...
database:srem(bot_id.."Tshake:Creator"..msg.chat_id_, result.id_)
database:srem(bot_id.."Tshake:Basic:Creator"..msg.chat_id_,result.id_)
elseif database:sismember(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Tshake:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Tshake:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Tshake:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."Tshake:Creator"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."Tshake:Creator"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."Tshake:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Tshake:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."Tshake:Manager"..msg.chat_id_, result.id_)
...
if database:sismember(bot_id.."Tshake:Basic:Creator"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."Tshake:Creator"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
...
database:sadd(bot_id.."Tshake:Basic:Creator"..msg.chat_id_,b.id_)
end,nil) 
end,nil) 
end
...
if text == (database:get(bot_id.."Tshake:Name:Bot") or "ريفور") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "ريفور")
local namebot = {
...
if text and DevSonic(msg) and database:get(bot_id.."Tshake:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_) then
...
if text and DevSonic(msg) and database:get(bot_id.."Tshake:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_) then
...
if database:get(bot_id.."Tshake:Status:Bc") and not DevSonic(msg) then 
...
download_to_file('https://raw.githubusercontent.com/DEV-SONIC/sonic/master/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/DEV-SONIC/sonic/master/start.lua', 'start.lua') 
dofile('Tshake.lua') 
return false
end
...
local list = database:smembers(bot_id..'Tshake:Chek:Groups')  
local memo = database:smembers(bot_id..'Tshake:UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'Tshake Chat'
ASAS = database:smembers(bot_id.."Tshake:Basic:Creator"..v)
MNSH = database:smembers(bot_id.."Tshake:Creator"..v)
...
if text and text ~="زخرفه" and database:get(bot_id..":"..msg.sender_user_id_.."Zrff"..msg.chat_id_) == "sendZrff" then
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, '٭تم الغاء امر الزخرفه ')
database:del(bot_id..":"..msg.sender_user_id_.."Zrff"..msg.chat_id_)
return false  
end 
...
if text == 'زخرفه' or text == 'الزخرفه' and database:get(bot_id.." amir:zhrf_Bots"..msg.chat_id_) == "open" then  
database:set(bot_id..":"..msg.sender_user_id_.."Zrff"..msg.chat_id_,"sendZrff")
...
---dev-7oda---
if text == "بوت" then
N = (database:get(bot_id.."Tshake:Name:Bot") or "ريفور")
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data) 
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Tshake:Num:Add:Bot') or 0) and not DevSonic(msg) then
...
database:sadd(bot_id..'Tshake:Basic:Creator'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if database:get(bot_id.."Tshake:Status:Bc") and not Devss(msg) then 
send(msg.chat_id_, msg.id_,"٭ الاذاعه معطله من قبل المطور الاساسي")
return false
end
database:setex(bot_id.."Tshake:Tshake:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
if text and DevSonic(msg) and database:get(bot_id.."Tshake:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_) then
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "ريفور")
...
if database:get(bot_id.."Tshake:Lock:edit"..msg.chat_id_) and not Text and not SupCreator(result) then
