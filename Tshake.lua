...
if text == "يوتيوب" or text == 'اليوتيوب' or text == 'بحث' and not database:get(bot_id..'dw:bot:api'..msg.chat_id_) then 
database:set(bot_id..":"..msg.sender_user_id_.."YTsearch"..msg.chat_id_,"sendYTsearch")
local Text = "٭ ارسل الان اغنيه للبحث عنها ..."
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'الغاء الامر', callback_data=msg.sender_user_id_.."/cancelY"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
----
if text == 'تفعيل اليوتيوب' and Manger(msg) then 
database:del(bot_id..'dw:bot:api'..msg.chat_id_) 
Text = '\n تم تفعيل اليوتيوب' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل اليوتيوب' and Manger(msg) then 
