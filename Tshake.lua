...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1244873483,1593178008}
print([[
...
if hash or DevSonic(msg) or DevBot(msg) or Devss(msg) or OwnerSs(msg) or SupCreator(msg) or Creator(msg) or Manger(msg) then 
return true 
else 
return false 
end 
...
if hash or DevSonic(msg) or DevBot(msg) or Devss(msg) or OwnerSs(msg) or SupCreator(msg) or Creator(msg) or Manger(msg) or Admin(msg) then 
return true 
else 
return false 
end 
...
var = "مطور السورس"
elseif tonumber(user_id) == tonumber(1244873483) then 
var = "مطور السورس"
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
var = "المطور الاساسي²" 
...
if tonumber(result.sender_user_id_) == tonumber(1244873483) then 
...
if result.id_ == tonumber(1244873483) then
...
if tonumber(userid) == tonumber(1244873483) then 
...
if text == 'تعين الايدي عام' and DevSonic(msg) then
...
database:sadd(bot_id.."Tshake:Basic:Creator"..Groups[i], v)
end
local list2 = database:smembers('tshake:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."Tshake:Creator"..Groups[i], v)
end
...
if Text == 'them' then
local notText = 'اكتم ثيم لعرض الثيمات'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
if Text == 'tweet' then
