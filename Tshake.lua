...
database:sadd(bot_id..'Tshake:UsersBot',idg)
...
database:sadd(bot_id..'Tshake:UsersBot',v) 
end
...
zh = https.request('https://rudi-dev.tk/Amir1/Mahmoud.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n ٭ قائمه الزخرفه \nٴ ٭ ٴ≪━━━━━━━━━━━━≫ٴ ٭ ○ٴ \n"
i = 0
...
-----by-7oda--
if Chat_Type == 'GroupBot' then
if text and not database:sismember(bot_id..'Tshake:Chek:Groups',msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat) 
Reply_Status(msg,result.id_,'reply_Add','٭ تم تفعيل المجموعه ~ '..chat.title_..'')
database:sadd(bot_id..'Tshake:Chek:Groups',msg.chat_id_)
...
if v then
inline = {
{{text = '- الغاء ال@ .',callback_data="pito"..v}},
}
